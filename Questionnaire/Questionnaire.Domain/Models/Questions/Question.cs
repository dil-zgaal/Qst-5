...
public class QuestionDelta
{
    ...
    public PatchableArray<QuestionDelta>? SubQuestions { get; set; }
    ...
    private void ApplyQuestionDeltaPatchableArray(List<Question> list, PatchableArray<QuestionDelta> patch)
    {
