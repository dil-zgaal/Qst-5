...
public class QuestionnaireService : IQuestionnaireService
{
    ...
    public async Task<IEnumerable<Contract.Models.Questionnaire>> GetAllQuestionnairesAsync()
    {
        _logger.LogDebug("Getting all questionnaires");
        return await _repository.GetAllAsync();
    }

    public async Task<Contract.Models.Questionnaire?> GetQuestionnaireByTypeIdAsync(QuestionnaireId typeId)
    {
        _logger.LogDebug("Getting questionnaire with ID: {Id}", typeId);
        return await _repository.GetByTypeIdAsync(typeId);
    }

    public async Task<Contract.Models.Questionnaire> CreateQuestionnaireAsync(string title, string? description, List<Question> content)
    {
        _logger.LogInformation("Creating questionnaire: {Title}", title);

        var questionnaire = new Contract.Models.Questionnaire
        {
    ...
    public async Task<Contract.Models.Questionnaire?> UpdateQuestionnaireAsync(QuestionnaireId typeId, string title, string? description)
    {
    ...
    public async Task<Contract.Models.Questionnaire?> ApplyDeltaAsync(QuestionnaireId typeId, QuestionnaireDelta delta)
    {
